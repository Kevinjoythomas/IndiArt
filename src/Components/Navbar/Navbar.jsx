...
export const Navbar = () => {
  return (
    <>
      ...
      <a className="navbar-brand" href="#">IndiArt</a>
      ...
      <form className="d-flex" role="search">
        ...
        <button className="btn btn-outline-success" style={{ backgroundColor: '#e7bc91', borderColor: '#e7bc91', color: '#8B5E34'}} type="submit">Search</button>
      </form>
    </div>
  </div>
</nav>
